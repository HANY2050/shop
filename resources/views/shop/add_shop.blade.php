            ...
            <div class="col-md-12" >
                ...
                <div class="card">
                    ...
                    <div class="card-header" style="text-align: center">
                        <h5>اضافة بيانات المركز التجاري</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form  action="add_shop" method="post"  class="row" enctype="multipart/form-data"  style="text-align: right" >
                            ...
                            <div class="form-group col-md-12 "  >
                                ...
                                <input type="hidden" class="form-control" name="user_id" id="user_id" placeholder="" required
                                       value=" {{ Auth::user()->id }}" >
                            </div>
                            ...
                            <div class="form-group col-md-12 " >
                                ...
                                <input style="text-align: right"  type="text" class="form-control" name="shop_name" id="shop_name" placeholder="اكتب اسم  المركز التجاري" required
                                       value="" >
                            </div>

                            <div class="form-group col-md-12 ">
                                <label for="owner_name" >اسم مالك المركز التجاري</label>
                                <input style="text-align: right" type="text" class="form-control" name="owner_name" id="owner_name" placeholder="اكتب اسم مالك المركز التجاري" required
                                       value="" >
                            </div>
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <input  style="text-align: right"  type="text" class="form-control" name="addresses" id="product_total" step="any" placeholder="اكتب عنوان المركز التجاري" required
                                        value="" >
                            </div>
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <input  style="text-align: right" type="number" class="form-control" name="number_phone" id="number_phone" step="any" placeholder="اكتب رقم الهاتف " required
                                        value="" >
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 mb-4" >
                                        ...
                                        <div class="card image-card-upload" >
                                            ...
                                            <input   name="image_profile"  type="file"  class="form-control-file image-file-upload " id="image-" required  >
                                        </div>
                                    </div>
