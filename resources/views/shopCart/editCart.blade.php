                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('update')}}" method="post" class="row" enctype="multipart/form-data"  >
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <input type="file" class="form-control" name="photo_car" id="photo_car"  onchange="previewFile(this)"    />
                                <img    src={{asset($shop->photo_car)}}  id="previewImg" alt="profile image" style="max-width: 130px; margin-top:20px; "    />
