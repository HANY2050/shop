            ...
            <div class="col-md-12" >
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form  action="" method="post"  class="row" enctype="multipart/form-data"  style="text-align: right" >
                            ...
                            <div class="form-group col-md-12 ">
                                ...
                                <input style="text-align: right" type="text" class="form-control" name="owner_name" id="owner_name" placeholder=" اسم مالك المركز التجاري"
                            ...
                            <div class="form-group col-md-12 ">
                                <label for="product_total" > عنوان المركز التجاري</label>
                                <input  style="text-align: right"  type="text" class="form-control" name="addresses" id="product_total" step="any" placeholder=" عنوان المركز التجاري"
                            ...
                            <div  class="form-group col-md-12"  style="text-align: center" >
                                <div class="row">
                                    <div class="col-md-4 col-sm-12 mb-4" >
                                        <label for=""   > صورة شعار المركز التجاري </label>
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-4" >
                                        ...
                                        <div class="card image-card-upload" >
                                            ...
                                            <a href="#"  class="activate-image-upload" data-fileid="image-{{ $i }}" >
                                                ...
                                                @if( !is_null($shop)  && ! is_null($shop->ShopCart) && count($shop->ShopCart)>0)
                                                    @if( isset($shop->ShopCart[$i]) && ! is_null($shop->ShopCart[$i] &&  !empty($shop->ShopCart[$i])))
                                                        <img id="{{'iimage-'.$i}}" src="{{ asset($shop->ShopCart[$i]->photo_car) }}" class="card-img-top" >
