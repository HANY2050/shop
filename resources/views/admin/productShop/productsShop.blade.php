    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12" >
                ...
                <div class="card">
                    <div class="card-header">{{ __('productsShop') }} <a class="btn btn-primary"  href="{{route('new-productShop')}}" ><i class="fas fa-plus-circle"></i></a> </div>
                    <div class="card-body">
                                ...
                                <div class="col-md-4" >
                                    <div class="alert alert-primary" role="alert">
                                     ...
                                     {!! (count( $product->images ) > 0) ?'<img    alt=""   class="img-thumbnail card-img" src="'.($product->images[0]->url )  .'">':''!!}
                                        ...
                                        <a class="btn btn-success m-2"  href="{{route('update-productShop-form', ['id'=>$product->id])}}" >Update Product</a>
                                                                             </div>
